...
<div id="listado">
    ...
    <div class="row justify-content-center">
        <div class="col-6" >
            <?php echo anchor('postulante/editar_cv/id/' . $id, 'Volver al menu', 'class="btn btn-default btn-etika"'); ?>
        </div>
        <!--<div class="col-6">-->
            <?php
            if ($secundaria) {
//                echo anchor('postulante/trayectoria_laboral', 'Siguiente Paso', 'class="btn btn-default btn-etika"');
