...
<?php echo form_open_multipart('Prueba_cinco/guardar_intento/'.$pla_id.'/'.$id_grupo.'/'.$ideval); ?>
<div class="row justify-content-center justify-content-md-around">
    <div class="col-md-9 text-left">
		<?php  echo $texto;?>
        <p></p>
        <img class="logo" src="<?php echo $this->tool_entidad->sitio() . 'files/img/prueba_cinco/captura.png'; ?>" />
	</div>
