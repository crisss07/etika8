...
Si pasa a una siguiente etapa deberá llenar su CV en el formato ETIKA.">
                    ...
                    <div class="col-6 sin-padding">
                        ...
                        <button type="submit" class="btn-etika btn" data-url="<?php echo $sitio . 'convocatoria/postular'; ?>">CV formato Etika</button>
...
<div class="modal fade" id="modal-cv-temporal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="butom" class="btn btn-primary cv-temporal" data-url="<?php echo $sitio . 'convocatoria/cvtemporal'; ?>" data-dismiss="modal">Continuar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function verifica_cv(){
        ...
        if (cont == 2) {
            ...
            // window.location.href = "<?php echo $sitio . 'convocatoria/cvtemporal'; ?>";
        }
    }
</script>
