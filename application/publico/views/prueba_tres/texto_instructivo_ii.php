...
<?php echo form_open_multipart('Prueba_tres/guardar_intento/'.$pla_id.'/'.$id_grupo.'/'.$ideval); ?>
<div class="row justify-content-center justify-content-md-around">
...
<div class="row justify-content-center justify-content-md-around">
    <div class="col-md-9">
         <button type="submit" class="btn-etika btn" id="guardar" >Comenzar Prueba</button>
    </div>
</div>
</form>
