...
//                                $fila[$prefijo.$fecha]='aaaa-mm-dd';
            ...
            <table class="tamanio_campos">
                <tr>
                    ...
                    <td align="right"><input type="radio" name="<?php echo $prefijoF . $nombre; ?>" value="1" <?php echo $valor1; ?> /> <span class="texto3">Masculino</span></td>
                    <td align="left"><input type="radio" name="<?php echo $prefijoF . $nombre; ?>" value="2" <?php echo $valor2; ?> /> <span class="texto3">Femenino</span></td>                    
                    <td align="left" width="335"> &nbsp; </td>
                </tr>
            </table>
            <table class="tamanio_campos">
