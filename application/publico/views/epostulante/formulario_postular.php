...
<div class="container">
    ...
    <div class="row justify-content-md-center align-items-md-center">
        <div class="col-md-6 col-lg-5 col-xl-4" style="border: 1px solid white; background: #fff;padding: 20px;border-radius: 20px;">
            <div id="cambiar_form">
                <?php echo form_open_multipart(@$action . 'epostulante/postular', ['id' => 'cv_adj']); ?>
            </div>
            <!-- <input type="text" name="id_accion" id="id_accion" value="<?php //echo $action; ?>"> -->
            <div class="row text-left">
                ...
                <div class="col-md-12">
                    ...
                    if (form_error($prefijo . $pass))
                        echo '<div id="salario_mensaje" class="error">' . form_error($prefijo . $pass) . '</div>';
                    ?>
                ...
                <div class="col-md-12">
                    ...
                    if (form_error($pass))
                        echo '<div id="mensaje_contador" class="error">' . form_error($pass) . '</div>';
                    ?>
...
Si pasa a una siguiente etapa deberá llenar su CV en el formato ETIKA.">
                    ...
                    <div class="col-6 sin-padding">
                        ...
                        <!-- <input class="btn-etika btn" type="button" value="CV formato Etika" data-url="<?php //echo $sitio . 'epostulante/postular'; ?>" /> -->
                    </div>
                </div>
                <br/>
                <p><?php echo @$msj; ?></p>
...
<div class="modal fade" id="modal-cv-temporal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary cv-temporale" data-url="<?php echo $sitio . 'convocatoria/editardatos'; ?>" data-dismiss="modal">Continuar</button>
                <!--<button type="butom" class="btn btn-primary cv-temporale" data-url="<?php echo $sitio . 'convocatoria/cvtemporal'; ?>" data-dismiss="modal">Continuar</button>-->
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    function verifica_cv(){
        ...
        // $('#boton_cv').html(`<input type="hidden" name="cv_boton" value="${1}"/>
        //                     <input type="hidden" name="cv_salario" value="${salario}"/>
        //                     <input type="hidden" name="cv_contador" value="${contador}"/>
        //                     <input type="hidden" name="cv_disponibilidad" value="${disponibilidad}"/>`);
