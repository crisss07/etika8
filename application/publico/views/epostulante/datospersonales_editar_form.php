...
//            para nombre
            ...
            ?>
            <label style="float: left; margin-bottom: -10; padding: 0; font-size: 9px;">Apellido Paterno</label>
            <?php
...
//             para apellido paterno
            ...
            if (form_error($prefijo . $nombre))
                echo '<div class="error">' . form_error($prefijo . $nombre) . '</div>';
            ?>
            <label style="float: left; margin-bottom: -10; padding: 0; font-size: 9px;">Apellido Materno</label>
            <?php
...
//            para nacionalidad
            ...
            <!--pais de residencia-->
            <label style="float: left; margin-bottom: -10; padding: 0; font-size: 9px;">pais de residencia</label>
...
//                echo '<div class="error">' . form_error($prefijoF . $pass) . '</div>';
            ...
            <div class="col-md-12 text-right">
                ...
                <button type="submit" style="border: 0; background: transparent" class="boton_aceptar"><img src="<?php echo $this->tool_entidad->sitio() . 'files/img/maq/guardar.gif'; ?>" alt="submit" />GUARDAR</button>
                    <?php
                    echo anchor($this->controlador . 'editar_cv/id/' . $_SESSION[$this->presession . 'id'], '<img border="0" src="' . $this->tool_entidad->sitio() . 'files/img/maq/cancelar.gif" /> CANCELAR', array('class' => 'boton_cancelar'));
                    ?>
