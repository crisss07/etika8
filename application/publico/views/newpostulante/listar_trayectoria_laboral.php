...
<div id="listado">
    ...
    <div class="row">
        <div class="col-6">
            <?php echo anchor('newpostulante/instruccion_formal', 'paso anterior', 'class="btn btn-default btn-etika"'); ?>
        </div>
        <div class="col-6">
            <?php
            // if ($trayectorias && $sintesis['pos_ambito_exp']) {
            if ($sintesis['pos_ambito_exp']) {
                echo anchor('newpostulante/informacion_adicional', 'siguiente paso', 'class="btn btn-default btn-etika"');
            } else {
                ?>
