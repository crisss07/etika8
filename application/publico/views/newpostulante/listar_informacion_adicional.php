...
<div id="listado">
    ...
    <form action="<?php echo $sitio . $this->controlador . 'guardar_editar_informacion_adicional' ?>" method="post" id="form_listar_fsimple">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <div class="row text-left justify-content-center container-ingles">
                                ...
                                <div class="col-2 text-center"><h4 class="text-cafe">Excelente</h4></div>
                                <div class="col-2 text-center"><h4 class="text-cafe">bueno</h4></div>
                                <div class="col-2 text-center"><h4 class="text-cafe">Regular</h4></div>
                                <div class="col-2 text-center"><h4 class="text-cafe">Básico</h4></div>
                            </div>
        ...
        <div class="row">
            <div class="col-6">
                <?php echo anchor('newpostulante/trayectoria_laboral', 'paso anterior', 'class="btn btn-default btn-etika"'); ?>
            </div>
            <div class="col-6">
                <input name="enviar" type="submit" class="btn btn-default btn-etika" value="Siguente paso"> 
            </div>
        </div>
    </form>
