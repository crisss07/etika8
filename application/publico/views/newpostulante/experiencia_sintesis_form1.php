...
//            ambito
            $nombre = 'ambito_exp';
            echo form_label(' Ámbito en el que clasificaría su experiencia: ', $prefijoF . @$nombre);
            ?>
            <br/>
            ...
            &nbsp; <input type="checkbox" name="<?php echo $prefijoF . $nombre . '2'; ?>" value="2" <?php echo @$valor_ambexp2; ?> /> &nbsp; <span class="texto3 text-mayusculas">Entidad Pública</span><br/>
