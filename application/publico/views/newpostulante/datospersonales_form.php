...
$pais_otro = "";
if (@$fila[$prefijoF . 'pai_id'] != 1 && @$fila[$prefijoF . 'pai_id'] != -1) {
...
//            documento
            ...
            <div class="row">
                <div class="col-md-6 text-left">
                    <label><?php
                        echo ($fila[$prefijo . 'tipodoc'] == 1) || $fila[$prefijo . 'tipodoc'] == 3 ? 'Ci:' : 'Pasaporte:';
...
//                'placeholder' => 'Pretensión Salarial Referencial (en Bs.)'
//            ));
...
//             terminos de servicio 
            ...
            <!--cuadro acepto-->
            <br/>
            <a class="enlace_terminos" href="#">LEER LOS TÉRMINOS DE SERVICIO COMPLETO</a> 
            <?php
            $nombre = 'acuerdo';
