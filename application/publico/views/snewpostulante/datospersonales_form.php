...
//            documento
            ...
            <div class="row">
                <div class="col-md-6 text-left">
                    <label><?php
                        echo $_SESSION[$this->presession . 'tipodoc'] == '2' ? 'Pasaporte:' : 'Ci:';
            ...
            <div class="row">
                <div class="col-md-12" align="left">
                    <div class="form-group">
                        ...
                        <small style="font-size: 9px;"> Año-mes-dia </small> </div>
                </div>
            </div>
             <?php
       ...
       <!--      <div class="row justify-content-between">
              ...
              <div class="row">
                <div class="col-md-4" align="left">                    
                        <label for="documento" style="font-size: 11px;">Género:</label>                    
                </div>
                <div class="col-md-4" align="left">
                    <div class="form-row">
...
//            para nacionalidad
            ...
            <!-- nacionalidad nueva -->
                 ...
                 <div class="col-md-4" align="left">
                        ...
                        <label for="documento" style="font-size: 11px; ">Nacionalidad:</label>
            ...
            <?php
            if (form_error('pai_id'))
                echo '<div class="error">' . form_error('pai_id') . '</div>';
            ?>
...
//            confirmar correo electronico
            $nombre = 'email1';
            echo "<input type='text' name='" . $prefijo . $nombre . "' id='" . $prefijo . $nombre . "'
                                    class='input1_normal input-etika' size='30' value='" . @$fila[$prefijo . $nombre] . "' placeholder='Confirmar Correo Electrónico'/>";
            ?>
                <div class="col-md-12">
                    <span class="text4">Nota: Porfavor utilice su correo personal.</span>
                </div>
            ...
            <?php
                if (@$errorEmail)
                    echo '<div class="error"><p>' . $errorEmail . '</p></div>';
                ?> 
...
//                'placeholder' => 'Pretensi? Salarial Referencial (en Bs.)'
//            ));
...
//             terminos de servicio 
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-right">
                    <input name="enviar"  type="submit" class="btn btn-default btn-etika" value="Siguiente paso">
...
<script>
    ...
    $(function () {
        ...
        $("#fecha").datepicker({
            ...
            dayNames: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "S?ado"],
