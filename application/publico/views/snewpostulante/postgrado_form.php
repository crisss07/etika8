...
//            desde
            ...
            <div class="row">
                <div class="col-md-4 text-left">
                    <?php echo form_label('Desde: <span class="texto3">&nbsp;Año-mes</span>', @$prefijo . $fecha); ?>

                </div>
                <div class="col-md-8 text-right">
                    <input maxlength="7" type="input" class="input1_normal input-etika" style="color:#aca899;" id="<?php echo $prefijo . $fecha; ?>" name="<?php echo $prefijo . $fecha; ?>" size="30" onFocus="if (this.value == 'aaaa-mm') {
                                this.value = '';
...
//            hasta
            ...
            <div class="row">
                <div class="col-md-4 text-left">
                    <?php echo form_label('Hasta: <span class="texto3">&nbsp;Año-mes</span>', $prefijo . $fecha); ?>
                </div>
                <div class="col-md-8 text-right">
                    <input maxlength="7" type="input" class="input1_normal input-etika" style="color:#aca899;" id="<?php echo $prefijo . $fecha; ?>" name="<?php echo $prefijo . $fecha; ?>" size="30" onFocus="if (this.value == 'aaaa-mm') {
                                this.value = '';
            ...
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">Institución</label>
            <?php
//            institucion
            $nombre = 'institucion';
            ...
            ?>
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">País</label>
            <?php
//            pais
            $nombre = 'pais';
//            echo form_label('País: ', $prefijo . $nombre); 
            ...
            if (form_error($prefijo . $nombre))
                echo '<div class="error">' . form_error($prefijo . $nombre) . '</div>';
            ?>
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">Grado</label>
            <?php
//            grado
            $campo1 = 'grado';
            echo form_dropdown($prefijo . $campo1, $this->grados, set_value($prefijo . $campo1, $fila[$prefijo . $campo1]), 'class="custom-select custom-select-sm input-etika"');

            if (form_error($prefijo . $campo1))
                echo '<div class="error">' . form_error($prefijo . $campo1) . '</div>';
            ?>
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">Área Post Grado</label>
            <?php
...
//            echo form_label('Área de Post Grado: ', $prefijo . $nombre);
            ...
            echo "<input type='text' name='" . $prefijo . $nombre . "' id='" . $prefijo . $nombre . "'
                                    class='input1 input-etika' size='28' onblur='Mayusculas(this.value,this.id)' value='" . $fila[$prefijo . $nombre] . "' placeholder='Área de Post Grado'/>";
            if (form_error($prefijo . $nombre))
                echo '<div class="error">' . form_error($prefijo . $nombre) . '</div>';
            ?>
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">Tema Tesis</label>
            <?php
...
//            echo form_label('Tema Tesis: ', $prefijo . $nombre);
            ...
            if (form_error($prefijo . $nombre))
                echo '<div class="error">' . form_error($prefijo . $nombre) . '</div>';
            ?>
            <label style="float: left; margin: 0; padding: 0; font-size: 9px;">Nota de la Tesis</label>
            <?php
