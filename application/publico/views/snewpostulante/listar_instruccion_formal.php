    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-md-offset-2">
            <div class="alert alert-warning">
                <strong>Nota!</strong> Esta información no es obligatoria hasta una siguiente etapa.
            </div>
                    ...
                    <div id="collapseThree" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            ...
                            if ($postgrado) {
                                ...
                                ?>
                                <p>No tiene ningun Post Grado.</p>
                                <?php
                            }
                            ?>
                        </div>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            ...
                            if ($superior) {
                                ...
                                ?>
                                <p>No tiene ningun Educación Superior.</p>
                                <?php
                            }
                            ?>
                        </div>
                    ...
                    <div id="collapseOne" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            ...
                            if ($secundaria) {
                                ...
                                ?>
                                <p>No tiene ningun Educación Secundaria.</p>
                                <?php
                            }
                            ?>
                        </div>
...
<div id="listado">
    ...
    <div class="row justify-content-center">
        <div class="col-6" >
            <?php echo anchor('snewpostulante/editar_datospersonal/id/' . $id, 'Paso Anterior','class="btn btn-default btn-etika"'); ?>
            <?php // echo anchor('snewpostulante/editar_cv/id/' . $id, 'Volver al menu', 'class="btn btn-default btn-etika"'); ?>
        </div>
        <div class="col-6">
            <?php
            echo anchor('snewpostulante/trayectoria_laboral', 'Siguiente Paso', 'class="btn btn-default btn-etika"');
            ?>
        </div>
    </div>
</div>
