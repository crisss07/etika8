...
//            maximo nivel alcanzado
            ...
            <div id="experiencia_sup" style="<?php echo @$display; ?>">
                ...
                <?php echo mb_convert_encoding(chr(241-32), "UTF-8");  ?>
                <?php
                $campo1 = 'max_nivel';
...
<script type="text/javascript">
    ...
    if ($('input[type=checkbox]:checked').length === 0) {
        e.preventDefault();
            $('#errror').html('<div class="error">Debe seleccionar al menos un Ambito en el que clasificaría su experiencia</div>');
            // alert('Debe seleccionar al menos un Ambito en el que clasificaría su experiencia');
        } 
});
</script>