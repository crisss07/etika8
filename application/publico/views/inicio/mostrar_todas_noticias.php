                    ...
                    <div class="col-md-6 " align="center">
                        <div class="contenedor-novedades-img" >
                            <a href="<?php echo $sitiop.'ninicio/mostrar_noticia/'.$nt_row[$i]['not_id']; ?>" title="Ver Noticia" data-toggle="tooltip" >
                                <img src="<?php echo $this->tool_entidad->aws_url().'archivos/noticias/'.$nt_row[$i]['not_img1']; ?>" class="img-fluid-not" alt="Responsive image"  >
                            </a>
                        </div>
                        <p></p>
                 ...
                 <?php if ($j<count($nt_row)): ?>
                    <div class="contenedor-novedades-img" >
                        <a href="<?php echo $sitiop.'ninicio/mostrar_noticia/'.$nt_row[$i+1]['not_id']; ?>" title="Ver Noticia" data-toggle="tooltip" >
                            <img src="<?php echo $this->tool_entidad->aws_url().'archivos/noticias/'.$nt_row[$i+1]['not_img1']; ?>" class="img-fluid-not"  alt="Responsive image" >
                        </a>
                    </div>
                    <p></p>
                   ...
                   <!--  <div class="row" align="justify">
                    <div class="col-md-12" >
                        <?php 
                        $contenido_texto=$nt_row[$i+1]['not_contenido']; ?>
                        <?php $contenido_texto= substr($contenido_texto, 0, 200);
                        echo   $contenido_texto;
                         ?>
                    </div>
                    </div> -->
