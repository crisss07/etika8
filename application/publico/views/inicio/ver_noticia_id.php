...
<div class="row justify-content-center">
        <div class="col-md-10 " >
            <?php if ($validacion_noticias_etika==1): ?> 
                <div class="row justify-content-center">
                    <div class="col-md-10" align="center" style="color:#000;text-transform: uppercase;font-size:22px;">
                       <?php echo $nt_row->not_titulo; ?>
                    </div>
                </div>
                <p></p>
                <p></p>
                <div class="row">
                    <div class="col-md-12" align="center">
                         <img src="<?php echo $this->tool_entidad->aws_url().'archivos/noticias/'.$nt_row->not_img1; ?>" class="img-fluid-not" alt="Responsive image" >
                    </div>
                </div>
                <p></p>
                <p></p>
                <div class="row" align="justify">
                    <div class="col-md-12" >
                        <?php echo $nt_row->not_contenido; ?>
                    </div>
                </div>

                  <p></p>
                <?php if ($nt_row->not_adj!="" || $nt_row->not_adj!=NULL ): ?>
                    <div class="row">
                        <div class="col-md-12">
                       <!--  Archivo adjunto: -->
                        <a href="<?php echo $this->tool_entidad->aws_url().'archivos/noticias/'.$nt_row->not_adj; ?>" title="Descargar" data-toggle="tooltip"  download>
                            <img border="0" width="150px"  src="<?php echo $this->tool_entidad->sitio() . 'files/img/descargar_etika.png'; ?>" />
                            <!-- <?php echo $nt_row->not_adj; ?>  -->
                    </a>
                        </div>
                    </div>
                <?php endif ?>
