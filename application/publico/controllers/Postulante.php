<?php
//require_once APPPATH.'controllers/Controladoradmin.php';
...
//                para colocar al postulante en disponibilidad inmediata
                ...
                if ($id && $idF) {
                    ...
                    redirect('postulante/instruccion_formal');
                }
            }
        }
    }
...
//                para actulizar la fecha de uno de los tab
                ...
                redirect('postulante/trayectoria_laboral');
            }
        }
    }
    ...
    function postgrado_nuevo() {
        ...
        if ($this->input->post('sin_postgrado')) {
            redirect('postulante/superior_nuevo');
        } else {
