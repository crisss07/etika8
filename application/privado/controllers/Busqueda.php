...
class Busqueda extends Controladoradmin {
...
//        parent::Controller();
    ...
    function exhaustiva() {
        $this->cabecera['acticion'] = 'Exhaustiva';
        $contenido['cabecera'] = $this->cabecera;
        ...
        $this->load->view($this->carpeta . 'busqueda', $contenido);
