...
class Index extends CI_Controller
{
    ...
    function index()
    {
        //var_dump(isset($_SESSION[$this->presession.'usuario']));exit();
       ...
       // var_dump("aut");
        ...
        else
        {
            ...
            if (count($fila) == 1) {
                ...
                //codigo google
                $id_usuario=$fila[$prefijo . 'id'];
                
                //$codigo_secreto=$fila['google_auth_code']; 
                

                 $id_usuario = base64_encode($id_usuario);


                 //borrar los archivos creados en los reportes
                 // $files = glob('./archivos/reporte_imagenes/*'); // get all file names
                 //    foreach($files as $file){ // iterate files
                 //      if(is_file($file))
                 //        unlink($file); // delete file
                 //    }
                    //finde borrar archivos
                    redirect('Autenticar/auth/'.$id_usuario);
