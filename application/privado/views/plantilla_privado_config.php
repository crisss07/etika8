            ...
            <div id="cabeza">
                    ...
                    <table width="100%" border="0" class="tabla_cabeza">
                        <tr>
                            <td width="50%" valign="middle" align="left">
								<img width="500px" src="<?php echo $this->tool_entidad->sitio(); ?>files/img/privado/logo-etika.png" alt="logo">
                            </td>
                ...
                <div id="cabeza_menu_arriba">
                    <div class="menu_horizontal">
                        <ul style="padding:0 auto 0 auto;">
