...
<div class="row">
  <div class="col-md-4" style="font-size:16px;vertical-align: center;" align="right">Texto de instructivo:</div>
...
<div class="row" align="center" >
  <div class="col-md-12">
    <?php echo form_submit('enviar', 'Guardar', 'class="btn-etika btn"'); ?>
  </div>  
</div>
</form>
