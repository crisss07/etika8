            ...
            <table  align="center" class="tabla_listado"  cellspacing="0" width="100%">
                ...
                foreach ($datos as $fila) {
                    ...
                    <!--fin de color a las celdas-->
                        ...
                        <td align="<?php echo $alineacionw; ?>" valign="<?php echo $alineacionh; ?>">
                            <?php
//                            if ($fila[$prefijo . 'id'] != 1 && $fila[$prefijo . 'id'] != 10) {
                                $id = $fila[$prefijo . 'id'];
                                echo anchor($this->controlador . 'eliminar/id/' . $fila[$prefijo . 'id'] . '/idp/' . $this->idp, '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">', array('class' => 'enlace_a1', 'onclick' => "return confirmarVerificar('$msj_confirmar','$id','$this->idp')"));
//                            }
                            ?>
