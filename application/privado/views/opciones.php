 <?php
 if(isset($this->opciones['nuevo'])){$nuevo=$this->opciones['nuevo'];}else{$nuevo='Nuevo';}
 if(isset($this->opciones['listado'])){$listado=$this->opciones['listado'];}else{$listado='Listado';}
