  ...
  <div class="col-md-8" >
    <?php for ($i=0; $i <16 ; $i++) { ?>
      ...
      <div class="form-group row">
        <label class="control-label text-right col-md-1"><?php echo $data[$i]['pre_nro']; ?> .- </label>
        <div class="col-md-10">

          <input type="text" class="form-control input1" value="Prefiere generar y construir sobre las ideas que implementarlas." name="" required="">
        </div>
      </div>
    <?php } ?>
  </div>
