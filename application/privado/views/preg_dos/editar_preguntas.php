...
<?php echo form_open_multipart('Prueba_dos/update_preguntas'); ?>   
  ...
  <div class="col-md-8" >
    ...
    <?php for ($i=$num_ini; $i <=$num_fin ; $i++) { ?>
      ...
      <div class="form-group row">
        <label class="control-label text-right col-md-1"><?php echo $dp[$j]['pre_nro']; ?> .- </label>
        <div class="col-md-11">

          <input type="text" class="form-control input1" name="p<?php echo $i; ?>" value="<?php echo $dp[$j]['pre_texto']; ?>" required="">
        </div>
      </div>
      <?php $j++; ?>
    <?php } ?>
