...
<?php echo form_open_multipart('Prueba_dos/vista_preguntas/'.$id.'/'.$num_fin); ?>   
 ...
 <div class="row">
  <div class="col-md-6">
    ...
    <div class="row">
     ...
     <?php if ($i<8): ?>
         <input tabindex="<?php echo $data[$i]['pre_nro']; ?>" type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="p<?php echo $pi;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  onchange="sumarNum1(this.value)" > 
     <?php else: ?>
         <input tabindex="<?php echo $data[$i]['pre_nro']; ?>" type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="p<?php echo $pi;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  onchange="sumarNum3(this.value)" > 
...
<div class="col-md-6">
 <div class="row">
   ...
   <?php if ($i<8): ?>
       <input tabindex="<?php echo $data[$i+4]['pre_nro']; ?>" type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="p<?php echo $pi;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  onchange="sumarNum2(this.value)" >
   <?php else: ?>
                <input tabindex="<?php echo $data[$i+4]['pre_nro']; ?>" type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="p<?php echo $pi;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  onchange="sumarNum4(this.value)" >
           <?php endif ?>        
    ...
    <div class="col-md-6">
      <div class="row">
        ...
        <div class="col-md-2">
         ...
         <input type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="suma<?php echo $i-2;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  readonly>
       </div>
       <div class="col-md-10" align="left">
        Total &nbsp;
        <span id="validsuma<?php echo $i-2; ?>" style="font-size:16px;color: red;font-weight: bold;font-style: italic;"></span>
      </div>
  ...
  <div class="col-md-6">
    <div class="row">
      ...
      <div class="col-md-2">
       ...
       <input type="number" class="input1" maxlength="1" size="1" min="0" step="1" pattern="^[-/d]/d*$"  max="9"  id="suma<?php echo $i-1;?>" style="width: 60px;" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  readonly>
     </div>
     <div class="col-md-10" align="left">
      Total &nbsp;
      <span id="validsuma<?php echo $i-1; ?>" style="font-size:16px;color: red;font-weight: bold;font-style: italic;"></span>
...
<script>
  function sumarNum1(n1) {
    ...
    if (total>10) {
      ...
      //$("#suma1").addClass( 'form-control is-valid');
...
<script>
  function sumarNum2(n1) {
    ...
    total= total+ parseInt(val1)+parseInt(val2)+parseInt(val3)+parseInt(val4);
    valor='<b> la suma debe ser igual a <i>10</i></b>';
    if (total>10) {
