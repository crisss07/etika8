 ...
 <!-- <button onclick="ExportToExcel('xlsx')">
  ...
  <style>
    ...
    <tr class="cabecera_listado" border=1 >
      <td colspan="8">Puntajes Directos</td>
      <td colspan="4">Situaciones Positivas</td>
      <td colspan="4">Situaciones Negativas</td>
    </tr>
 ...
 <!-- # Evaluaciones  # Participantes Fecha Envio Configurar Envio  Editar  Eliminar -->
   ...
   <?php $sw=0;$j=1; ?>
    ...
    <?php endif ?>
     ...
     <td align="left"><?php echo $datos[$i]['com_nombre']; ?></td>
