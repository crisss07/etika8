...
<br>
        ...
        <table  align="center" class="tabla_listado"  cellspacing="0" width="100%">
            <tr class="cabecera_listado">
               ...
               if(@$this->enlaces){
                ...
                ?>
                <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">Estado</td>
                <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">Habilitar</td>
			...
			foreach ($datos as $fila){
				...
				?>
                   ...
                   {
                    ?>
                    <td align="center" valign="middle"> <input type='text' name='<?php echo 'orden'.$fila[$prefijo.'id'];?>' value='<?php echo $fila[$orden];?>' size="1" class="input2"></td>
                    <?php
                    }
                    ?>
                    <?php
                ...
                ?>
                    ...
                    <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">
                        ...
                        if($fila[$estado])
                        {
                            if($this->idp){
                                if($this->tip){
                                    echo anchor($this->controlador.'deshabilitar/id/'.$fila[$prefijo.'id'].'/idp/'.$this->idp.'/tip/'.$this->tip, $estado_accion,array('class' =>'enlace_a1'));
                                }
                                else{
                                    echo anchor($this->controlador.'deshabilitar/id/'.$fila[$prefijo.'id'].'/idp/'.$this->idp, $estado_accion,array('class' =>'enlace_a1'));
                                }
                            }
                            else{
                                if($this->tip){
                                    echo anchor($this->controlador.'deshabilitar/id/'.$fila[$prefijo.'id'].'/tip/'.$this->tip, $estado_accion,array('class' =>'enlace_a1'));
                                }
                                else{
                        ...
                        else
                        {
                            if($this->idp){
                                if($this->tip){
                                    echo anchor($this->controlador.'habilitar/id/'.$fila[$prefijo.'id'].'/idp/'.$this->idp.'/tip/'.$this->tip, $estado_accion,array('class' =>'enlace_a1'));
                                }
                                else{
                                    echo anchor($this->controlador.'habilitar/id/'.$fila[$prefijo.'id'].'/idp/'.$this->idp, $estado_accion,array('class' =>'enlace_a1'));
                                }
                            }
                            else{
                                if($this->tip){
                                    echo anchor($this->controlador.'habilitar/id/'.$fila[$prefijo.'id'].'/tip/'.$this->tip, $estado_accion,array('class' =>'enlace_a1'));
                                }
                                else{
                    ...
                    <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">
                        ...
                        if(@$this->idp){
                            ...
                            if(@$this->tip){
                                ...
                                echo anchor($this->controlador.'eliminarnot/id/'.$fila[$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">',array('class' =>'enlace_a1','onclick'=>"return confirmar('$msj_confirmar')"));
                            }
                        }
        ...
        <table>
           <tr>
               ...
               <td><input class="btn btn-etika" type="Submit" name="actualizarorden" value="Actualizar orden"/></td>
               <?php
               }
               ?>
              <?php
