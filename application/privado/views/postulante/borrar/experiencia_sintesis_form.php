...
<table id="form_admin">
    <tr>
        <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
            ...
            <?php echo form_label(' Ambito en el que clasificaría su experiencia: ', $prefijoF . $nombre); ?>
        </td>
        <td align="left" valign="<?php echo $alineacionhc2; ?>">
            ...
            <input type="checkbox" name="<?php echo $prefijoF . $nombre . '3'; ?>" value="3" <?php echo $valor_ambexp3; ?> /> Cooperación para el Desarrollo
        </td>
    </tr>
    <tr>
        <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
            <?php $campo1 = 'area_exp'; ?>
            <?php echo form_label(' Área de experiencia que usted resaltaría: ', $prefijoF . $campo1); ?>
        </td>
    ...
    <tr>
        <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
            ...
            <?php echo form_label(' Sector de experiencia que usted resaltaría: ', $prefijo . $campo1); ?>
        </td>
        <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
            <?php
    ...
    <tr>
        <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
            ...
            ?>
            <?php echo form_label(' Experiencia en supervisión: ', $prefijoF . $nombre); ?>
        </td>
        <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
                ...
                <table width="100%">
                    <tr>
                        <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
                            ...
                            <?php echo form_label('  No Supervición: ', $prefijoF . $campo1); ?>
                        </td>
                        <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
                            <?php
