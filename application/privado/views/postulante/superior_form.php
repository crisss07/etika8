    ...
    <table id="form_admin">
        <tr>
            <td colspan="2" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
                ...
                ?>
                <input maxlength="4" type="input" class="input1_normal" style="color:#aca899;" id="<?php echo $prefijo . $fecha; ?>" name="<?php echo $prefijo . $fecha; ?>" size="3" onFocus="if (this.value == 'aaaa') {
                            this.value = '';
                            this.style.color = '#000000';
                        }" onBlur="if (this.value == '') {
                                    this.value = 'aaaa';
                                    this.style.color = '#aca899';
                                }" value="<?php echo set_value($prefijo . $fecha, $fila[$prefijo . $fecha]); ?>" ><span class="texto2">&nbsp;A&ntilde;o</span>
                       <?php $fecha = 'hasta'; ?>
                ...
                <input maxlength="4" type="input" class="input1_normal" style="color:#aca899;" id="<?php echo $prefijo . $fecha; ?>" name="<?php echo $prefijo . $fecha; ?>" size="3" onFocus="if (this.value == 'aaaa') {
                       ...
                       if (form_error($prefijo . 'desde') || form_error($prefijo . 'hasta'))
                           echo '<div class="error">Debe ingresar unas correctas Fechas</div>';
                       ?>
            </td>
        </tr>
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
                ...
                <?php echo form_label('Instituci&oacute;n: ', $prefijo . $nombre); ?>
            </td>
...
//                ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
                <?php $nombre = 'pais'; ?>
                <?php echo form_label('Pa&iacute;s: ', $prefijo . $nombre); ?>
            </td>
            <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
                <?php
                echo "<input type='text' name='".$prefijo.$nombre."' id='".$prefijo.$nombre."'
...
//                ));
        ...
        <tr>
            ...
            <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
                <?php
                echo form_dropdown($prefijo . $campo1, $this->grados_sup, set_value($prefijo . $campo1, $fila[$prefijo . $campo1]));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1; ?>" valign="<?php echo $alineacionhc1; ?>">
                <?php $campo1 = 'area'; ?>
                <?php echo form_label(' &aacute;rea de profesion: ', $prefijo . $campo1); ?>
            </td>
            <td align="<?php echo $alineacionwc2; ?>" valign="<?php echo $alineacionhc2; ?>">
                <?php
                echo form_dropdown($prefijo . $campo1, $this->profesiones, set_value($prefijo . $campo1, $fila[$prefijo . $campo1]), 'class="select_profesion"');
                if (form_error($prefijo . $campo1))
                    echo '<div class="error">' . form_error($prefijo . $campo1) . '</div>';
                ?>
                <div id="pais" class="otra_profesion" <?php echo $displayProfesion; ?>>
                    ...
                    echo "<input type='text' name='".$prefijo."area_otro' id='".$prefijo."area_otro'
                                    class='input1' size='30' onblur='Mayusculas(this.value,this.id)' value='".$fila[$prefijo . "area_otro"]."' /> <- Escriba la Profesión";
//                    echo form_input(array(
//                        'name' => $prefijo . 'area_otro',
//                        'id' => $prefijo . 'area_otro',
//                        'class' => 'input1',
//                        'size' => '30',
//                        'onblur' => 'Mayusculas(this.value,this.id)',
//                        'value' => $fila[$prefijo . 'area_otro']
//                    )) . ' <- Escriba la Profesión';
