...
<div id="listado">
    ...
    $prefijo = 'pos_';
    ?>  
    <div align="left" ><?php echo anchor($this->controlador . 'editar/id/' . $fila_sup[$prefijo . 'id'], 'Atr&aacute;s', array('class' => 'enlace_retornar enlace_a1')); ?></div><br/>
                ...
                <tr>
                    ...
                    <td><?php
                        if ($fila[$prefijo . 'id'] != 0) {
                            echo anchor($this->controlador . 'editar_idioma/id/' . $fila[$prefijo . 'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">', array('class' => 'enlace_a1'));
                        } else {
                            echo anchor($this->controlador . 'idioma_nuevo/ids/' . $fila_sup['pos_id'] . '/id/0', '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">', array('class' => 'enlace_a1'));
                        }
                        ?></td>
                    <!--<td><?php echo anchor($this->controlador . 'eliminar_idioma/id/' . $fila[$prefijo . 'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">', array('class' => 'enlace_a1', 'onclick' => "return confirmar('$msj_confirmar')")); ?></td>-->
                </tr>
            ...
            <?php if ($idiomas) { ?>
                ...
                foreach ($idiomas as $fila) {
                    ...
                    <tr>
                        ...
                        ?>
                        <td><?php echo anchor($this->controlador . 'editar_idioma/id/' . $fila[$prefijo . 'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">', array('class' => 'enlace_a1')); ?></td>
                        <td><?php echo anchor($this->controlador . 'eliminar_idioma/id/' . $fila[$prefijo . 'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">', array('class' => 'enlace_a1', 'onclick' => "return confirmar('$msj_confirmar')")); ?></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
