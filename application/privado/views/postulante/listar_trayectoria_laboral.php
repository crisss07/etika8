...
?>
    ...
    <form action="<?php echo $sitio.$this->controlador.'procesar'?>" method="post" id="form_listar_fsimple">
        ...
        <table align="center" border="0" cellspacing="8">
            <tr>
                <td align="right"><h2>S&iacute;ntesis de Experiencia Laboral -></h2></td>
                <td align="left"><?php echo anchor($this->controlador.'editar_experiencia_sintesis/id/'.$fila_sup['pos_id'],'<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a3')); ?></td>
            </tr>
        </table>
        ...
        <table  align="center" class="tabla_listado"  cellspacing="0" width="900">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo anchor($this->controlador.'editar_trayectoria/id/'.$fila[$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));?></td>
                    <td><?php echo anchor($this->controlador.'eliminar_trayectoria/id/'.$fila[$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">',array('class' =>'enlace_a1','onclick'=>"return confirmar('$msj_confirmar')"));?></td>
                </tr>
            <?php }?>
            <?php }else{?>
                <tr>
