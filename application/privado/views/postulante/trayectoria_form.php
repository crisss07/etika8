    ...
    <table id="form_admin">
        <tr>
            <td colspan="2" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                if(@!$fila[$prefijo.$fecha])
                 ...
                 ?>
                <input maxlength="7" type="input" class="input1_normal" style="color:#aca899;" id="<?php echo $prefijo.$fecha;?>" name="<?php echo $prefijo.$fecha;?>" size="7" onFocus="if(this.value == 'aaaa-mm'){this.value='';this.style.color='#000000';}" onBlur="if(this.value == ''){this.value='aaaa-mm';this.style.color='#aca899';}" value="<?php echo set_value($prefijo.$fecha,$fila[$prefijo.$fecha]);?>" ><span class="texto2">&nbsp;A&ntilde;o-mes</span>
                <?php $fecha='hasta';?>
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' Nombre de la Organizaci&oacute;n: ', $prefijo.$nombre);?>
            </td>
...
//                      ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                <?php $campo1='tipo_org';?>
                <?php echo form_label(' Tipo de Organizaci&oacute;n: ', $prefijo.$campo1);?>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' Actividad Principal de la Organizaci&oacute;n: ', $prefijo.$nombre);?>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
...
//                      ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' 3 Principales Funciones Desempe&ntilde;adas dentro del Cargo: ', $prefijo.$nombre);?>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
                    echo "<textarea name=".$prefijo.$nombre." id=".$prefijo.$nombre."
...
//                      ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                <?php $nombre='pais';?>
                <?php echo form_label(' Pa&iacute;s - Ciudad : ', $prefijo.$nombre);?>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
                    echo "<input type='text' name=".$prefijo.$nombre." id=".$prefijo.$nombre."
...
//                      ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' N&deg; de Subordinados: ', $prefijo.$nombre);?>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' Tel&eacute;fono(s) de la Organizaci&oacute;n: ', $prefijo.$nombre);?><br/>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
...
//                      ));
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' Tel&eacute;fono(s) del Inmediato Superior: ', $prefijo.$nombre);?><br/>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
        ...
        <tr>
            <td class="texto_label" align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                ...
                <?php echo form_label(' Correo Electr&oacute;nico del Inmediato Superior: ', $prefijo.$nombre);?><br/>
            </td>
            <td align="<?php echo $alineacionwc2;?>" valign="<?php echo $alineacionhc2;?>">
                <?php
                    echo "<input type='text' name=".$prefijo.$nombre." id=".$prefijo.$nombre."
...
//                      ));
        ...
        <tr>
            <td class="texto_label"  align="<?php echo $alineacionwc1;?>" valign="<?php echo $alineacionhc1;?>">
                <?php echo form_label(' Estoy actualmente Trabajando en esta Organizaci&oacute;n: ');?>
            </td>
            <!-- <td class="texto_label" colspan="2" align=" echo $alineacionwc1;?>" valign=" echo $alineacionhc1;?>"> -->
            <td  align="left" valign="<?php echo $alineacionhc1;?>">
                <?php
                    if($fila[$prefijo.'actual']==1){
                            $actual='checked';
                        }
                    ?>
                    <!-- <b>Estoy actualmente Trabajando en esta Organizaci&oacute;n </b>  -->
                    
                    <input type="checkbox" name="<?php echo $prefijo.'actual'; ?>" value="1" <?php echo @$actual;?> /> Si
            </td>
        </tr>
    </table>
<br/>
