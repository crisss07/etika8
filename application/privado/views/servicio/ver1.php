    ...
    <div class="row justify-content-center">
        <div class="col-md-8 imagen" id="imagenes_2">
            ...
            <div class="d-flex justify-content-center align-items-center box-titulo" style="margin-right: 60px; margin-left: 60px;">
                <h2 class="text-center" style="font-size: 16px; text-transform: none; color: #222E3E; font-weight: 600;"><?php echo $fila['con_encabezado_redes']; ?></h2>
            </div>
            <?php if (!empty($logo_cliente)) { ?>
                <img class="solo_logo" style="margin: 30px; width: 30%;" src="<?php echo $this->tool_entidad->sitio().$logo_cliente;?>">
            <?php } ?>
            <!-- <img class="solo_logo" style="margin: 30px; width: 10%;" src="<?php echo $this->tool_entidad->sitio().'archivos/cliente/'. $logo_cli;?>"> -->
