...
<input type="image" src="<?php echo base_url();?>files/img/excel_exportar.jpg"  onclick="ExportToExcel('xlsx')" alt="submit"/>
 ...
 <!-- # Evaluaciones  # Participantes Fecha Envio Configurar Envio  Editar  Eliminar -->
        ...
        <td align="center" valign="">Tiempo Lectura (Min)</td>
   ...
   <?php $sw=0;$j=1; ?>
    ...
    <?php endif ?>
     ...
     <td align="left"><?php echo $datos[$i]['seg_tiempo_total']; ?></td> 
     <?php $suma_omitidos=$datos[$i]['om_a']+$datos[$i]['om_b']+$datos[$i]['om_c']; ?>
     <td align="left"><?php echo $suma_omitidos; ?></td> 
     <?php $suma_errores=$datos[$i]['er_a']+$datos[$i]['er_b']+$datos[$i]['er_c']; ?>
     <td align="left"><?php echo $suma_errores; ?></td> 
     <td align="left"><?php echo $datos[$i]['pe']; ?></td> 
   </tr>
      <?php $j++; ?>
     <?php } ?>
</table>
