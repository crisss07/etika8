...
<div id="listado" style=" padding: 20px;">
    ...
    <div align="left" ><a href="<?php echo $sitio.'Postulante/listar'; ?>" class="enlace_retornar enlace_a1" >Atrás</a></div><br>
    ...
    <div class="scrollh">
        <div class="row">
            <div class="col-md-4"></div>
                <div class="col-md-4"> 
                    <?php echo form_open_multipart('Postulacion/uploadPostulante'); ?>
        ...
        <table  class="tabla_listado" cellspacing="0" width="70%" >
            ...
            <tbody>
              <?php echo form_open_multipart('Postulacion/downZipSeleccionados'); ?>
                  <?php $color=0;?>
            <?php $sw=0; ?>
                ...
                <?php foreach ($lista as $row) { ?>
                    ...
                    $archivo=[];
                    $archivo=explode( '/', $row['Key'] );
					 /* $aux = substr($archivo[3], -5, 5); 
					 $aux2 = stristr($aux, ".");
					 $aux3 = strpbrk($aux, ".");
					 if(!@$archivo[4] && $aux3){  */
					 $mystring = $archivo[3];
						$findme   = '.';
						$posi = strpos($mystring, $findme);
						/* REVISAR SI ES UN DOCUMENTO
						print_r($archivo[3]);
						echo $posi; 
						*/
						if ($posi) {
                    ...
                    <!--fin de color a las celdas-->
                        <td>           
                          ...
                          <td style="width: 10px;font-size: 8px;" >
                              <a href="<?php echo $sitio.'Postulacion/eliminar_postulante?carpeta='.$nombre_carpeta.'&archivo='.$row['Key']; ?>" class="btn btn-warning btn-sm" title="Eliminar" data-toggle="tooltip"  > <i class="fas fa-trash-alt"></i></a>
                          </td>
                      </tr>
							...
							<ul class="icheck-list">                          
							 CARPETA DE EVALUACIONES          
							  ...
							  <td style="width: 10px;" colspan="2" >
									<a href="<?php echo $sitio.'Postulacion/ver_evaluaciones/'.$id; ?>">
									Ver Carpeta
									</a>
							  </td>
                      </tr>
       ...
       <p></p>
           ...
           <div class="row">
            <div class="col-md-4">
                 ...
                 <div class="col-md-3" align="center">
                  <?php echo form_open_multipart('Postulacion/downZiPostulante'); ?>
