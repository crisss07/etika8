    ...
    <div class="scrollh">
        <div class="row">
            <div class="col-md-4"></div>
                <div class="col-md-4"> 
                    <?php echo form_open_multipart('Postulacion/upload'); ?>
         ...
         <div class="row">
                            <div class="col-md-3">
                                ...
                                <?php echo form_open_multipart('Postulacion/descargaZipSeleccionados'); ?>
                    ...
                    <!--fin de color a las celdas-->
                        <td>                          
                          ...
                          <td style="width: 10px;font-size: 8px;" >
                              ...
                              <a href="<?php echo $sitio.'Postulacion/eliminar_archivos?carpeta='.$nombre_carpeta.'&archivo='.$row['Key']; ?>" class="btn btn-warning btn-sm" title="Eliminar" data-toggle="tooltip"  > <i class="fas fa-trash-alt"></i></a>
                          </td>
                      </tr>
       ...
       <p></p>
           ...
           <div class="row">
            <div class="col-md-4">
                 ...
                 <div class="col-md-3" align="center">
                  <?php echo form_open_multipart('Postulacion/descargar_zip'); ?>
