...
<?php echo form_open_multipart('Prueba_dos/vista_preguntas/'.$id.'/1'); ?>   
...
<div class="row">
  ...
  <div class="col-md-8" align="justify">
    ...
    <p></p>
    <?php echo $datos[0]['zpla_texto_instructivo'] ?>
...
<div class="row" align="center" >
  <div class="col-md-12">
    <button type="submit" class="btn-etika btn" id="guardar" >Comenzar</button>
  </div>  
</div>
</form>
