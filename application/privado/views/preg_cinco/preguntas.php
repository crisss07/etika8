...
<?php echo form_open_multipart('Prueba_cinco/crear_preguntas'); ?>   
    ...
    <?php for ($i=1; $i <=25 ; $i++) { ?>
      ...
      <tr bgcolor="#f4f4f4">
        ...
        <td class="texto_label">
          <input type="text" class="form-control input1" name="cant<?php echo $i; ?>" required="">
        </td>
        
        <td style="width:200px;">
          <input type="text" class="form-control input1" name="cl<?php echo $i; ?>" required="">
        </td>
        <td >
          <input type="text" class="form-control input1" name="fech<?php echo $i; ?>" required="">
        </td>
        <td >
