  ...
  <table  align="center" class="tabla_listado"  cellspacing="0" width="100%" id="example">
   ...
   <tr >
         ...
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/vista_edicion_titulo/'.$resultado[0][$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
   </tr>
   <tr >
         <td align="center" valign="">Tiempo Prueba</td>         
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/vista_edicion_tiempo/'.$resultado[0][$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
   </tr>
   <tr class="fila-color-2">
         ...
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/vista_edicion_texto/'.$resultado[0][$prefijo.'id'].'/1', '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
   </tr>
   <tr >
         ...
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/vista_edicion_texto/'.$resultado[0][$prefijo.'id'].'/2', '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
   </tr>
   ...
   <tr class="fila-color-2">
         ...
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/editar_preguntas/'.$resultado[0][$prefijo.'id'], '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
                        <!-- redirect('Prueba_cinco/editar_preguntas/'.$id_pla.'/1');     -->
   </tr>
   <tr >
         <td align="center" valign="">Texto Despedida:
</td>         
         <td align="center" valign=""><?php
                        echo anchor('Prueba_cinco/vista_edicion_texto/'.$resultado[0][$prefijo.'id'].'/4', '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/editar.png" alt="editar">',array('class' =>'enlace_a1'));
                        ?></td>     
   </tr>
