...
<?php echo form_open_multipart('Prueba_cinco/updt_tiempo'); ?>   
...
<div class="row">
  ...
  <div class="col-md-4" align="left">
    <div class="form-group">
      ...
      <input type="number" class="form-control input1" min=1  value="<?php echo $valor_texto; ?>" name="tiempo_prueba" required="">
    </div> 
  </div>
</div>
