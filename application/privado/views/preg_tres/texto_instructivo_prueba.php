...
<?php echo form_open_multipart('Prueba_tres/upd_texto_prueba'); ?>   
<div class="row">
  <div class="col-md-2"></div>
  <div class="col-md-2" align="right" style="font-size:16px;">Texto Instructivo I:</div>
    ...
    <input type="hidden" value="<?php echo $id; ?>" name="id"    >
          ...
          <?php                 
                echo form_textarea(array(
                    'name' => 'texto_instructivo',
                    'id' => 'texto_instructivo',
                    'rows' => '5',
                    'cols' => '60',
                    'class'=>'textarea',
                    'class'=>'tinymce',
