...
<?php echo form_open_multipart('Prueba_tres/crear_preguntas_prueba'); ?>   
...
<div class="row justify-content-center">
  ...
  <div class="col-md-6">
    <table class="table table-bordered">
      ...
      <tr>
        <td>1.-</td>
        <td><input type="text" class="form-control input1"  name="p1" required="" placeholder="pregunta 1"></td>
      </tr>
      <tr>
        <td>a</td>
        <td><input type="text" class="form-control input1" name="1a" placeholder="opcion a" required=""></td>
      </tr>
      <tr>
        <td>b</td>
        <td><input type="text" class="form-control input1" name="1b"placeholder="opcion b"  required=""></td>
      </tr>
      <tr>
        <td>c</td>
        <td><input type="text" class="form-control input1" name="1c" placeholder="opcion c" required=""></td>
      </tr>
      <!-- p2 -->
      <tr bgcolor="#f4f4f4">
        <td class="texto_label" style="width:10px;">  <b>Nro</b> </td>
      ...
      <tr>
        <td>2.-</td>
        <td><input type="text" class="form-control input1" name="p2" required="" placeholder="pregunta 2"></td>
      </tr>
      <tr>
        <td>a</td>
        <td><input type="text" class="form-control input1" name="2a" placeholder="opcion a" required=""></td>
      </tr>
      <tr>
        <td>b</td>
        <td><input type="text" class="form-control input1" name="2b"placeholder="opcion b"  required=""></td>
      </tr>
      <tr>
        <td>c</td>
        <td><input type="text" class="form-control input1" name="2c" placeholder="opcion c" required=""></td>
      </tr>
      <!-- p3 -->
      <tr bgcolor="#f4f4f4">
        <td class="texto_label" style="width:10px;">  <b>Nro</b> </td>
      ...
      <tr>
        <td>3.-</td>
        <td><input type="text" class="form-control input1" name="p3" required="" placeholder="pregunta 3"></td>
      </tr>
      <tr>
        <td>a</td>
        <td><input type="text" class="form-control input1" name="3a" placeholder="opcion a" required=""></td>
      </tr>
      <tr>
        <td>b</td>
        <td><input type="text" class="form-control input1" name="3b"placeholder="opcion b"  required=""></td>
      </tr>
      <tr>
        <td>c</td>
        <td><input type="text" class="form-control input1" name="3c" placeholder="opcion c" required=""></td>
      </tr>
