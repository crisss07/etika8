        ...
        <tr>
          <td>
           ...
           if(!@$this->notitulo)
           {
            ...
            {
              ?>
              <span class="cabecera_titulo">Puntajes Estandar
</span>
              <?php
            }
...
<input type="image" src="<?php echo base_url();?>files/img/excel_exportar.jpg"  onclick="ExportToExcel('xlsx')" alt="submit"/>
 ...
 <!-- <button onclick="ExportToExcel('xlsx')">
  ...
  <style>
    ...
    <tr class="cabecera_listado" border=1 >
      <td colspan="30">Puntajes Directos</td>
 ...
 <!-- # Evaluaciones  # Participantes Fecha Envio Configurar Envio  Editar  Eliminar -->
        ...
        <td>
             <?php echo $data_factores[15]['letra']; ?>
        </td>
        <td>
             <?php echo $data_factores[16]['letra']; ?>
        </td>
        <td>
             <?php echo $data_factores[17]['letra']; ?>
        </td>
   ...
   <?php $sw=0;$j=1; ?>
    ...
    <?php endif ?>
     ...
     <td align="left"><?php echo $datos[$i]['edad']; ?></td>    
      ...
      <?php
       $valor_a=$datos[$i]['array_total_gral'];
       $valor_a=json_decode($valor_a);
       $longitud=count($valor_a);//23
...
<script>
  function ExportToExcel(type, fn, dl) {
       ...
       var wb = XLSX.utils.table_to_book(elt, { sheet: "Puntajes_Estandar" });
       
       return dl ?
         XLSX.write(wb, { bookType: type, bookSST: true, type: 'base64' }):
         XLSX.writeFile(wb, fn || ('Puntajes_Estandar.' + (type || 'xlsx')));
    }
</script>
