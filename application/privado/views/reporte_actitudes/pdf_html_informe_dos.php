...
<body>
		...
		<table width="100%">
			<tr >
				...
				<img width="100px" src="<?php echo $this->tool_entidad->sitio(); ?>files/pdf/logo_etikaPdf.jpg" alt="logo">
				</td>
				<td align="center">
					<p></p>
			RASGOS DE PERSONALIDAD (DETALLADO)						
<br>
	...
	<div class="invoice" style="width:1058px;padding:30px;">
			...
			<table  class="contenido_tabla borde_tabla" width="100%" >        
				<tbody>
					...
					<tr >
						...
						<td rowspan="26" style="width:350px;">
							    
							    <img width="350"  src="<?php echo $this->tool_entidad->sitio(); ?>files/pdf/chart_barra.png" alt="logo">
							    <br>
							<img width="350" height="620" style="margin-top: -14px;" 	src="https://quickchart.io/chart?w=350&h=800&c={
		type: 'horizontalBar',
		data: {
        ...
        xAxes: [{
            ...
            gridLines: {
                drawBorder: false,
						...
						<td align="left" class=" bordes_td" style="width:250px;">
						<b>El polo alto define una persona...</b>            	
						</td>            
					</tr>
