                    ...
                    <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">
                        ...
                        if($this->idp){
                            ...
                            if($this->tip){
                                ...
                                echo anchor($this->controlador.'editar/id/'.$fila[$prefijo.'id'], 'Editar',array('class' =>'enlace_a1'));
                            }
                        }
                    ...
                    <td align="<?php echo $alineacionw;?>" valign="<?php echo $alineacionh;?>">
                        ...
                        if($this->idp){
                            ...
                            if($this->tip){
                                ...
                                echo anchor($this->controlador.'eliminar/id/'.$fila[$prefijo.'id'], 'Eliminar',array('class' =>'enlace_a1','onclick'=>"return confirmar('$msj_confirmar')"));
                            }
                        }
