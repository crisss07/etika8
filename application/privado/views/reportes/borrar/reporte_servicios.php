...
<form action="<?php echo $sitio.$this->controlador.'excel';?>" method="post" id="form_listar_fsimple">
    ...
    <input type="hidden" name="titulo" value="<?php echo $this->cabecera['accion'];?>"/>
    <table align="center" width="100%" border="0">
        <tr>
            <td class="enlaces_add_edit" align="left" width="8%" >
                <?php  echo anchor($this->controlador.'postulante','Cancelar',array('class' =>'enlace_cancelar enlace_a1')); ?>
            </td>
