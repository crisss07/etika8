<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/files/multiselect/css_nuevo/multi-select.css">
<?php
$this->load->view('cabecera');
?>
<div id="listado"><div align="left" >
        <?php echo anchor('reportes/postulante', 'Atr&aacute;s', array('class' => 'enlace_retornar enlace_a1')); ?></div>
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <form method="post" action="<?php echo @$sitio . 'realizar_busqueda'; ?>" name="formularioCriterios">
                    ...
                    if ($value == 1) {
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2">
                                <label class="titulo1">Pa&iacute;s de residencia: </label>
                                <br>
                                ...
                                <select name="idpais" class="form-select-21" style="width: 300px;">
                                    <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Profesi&oacute;n: </label>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">&aacute;rea de experiencia: </label>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Ambito en el clasificar&iacute;a su experiencia: </label>
                                <br>
                                ...
                                <input type="checkbox" id="ambito3" value="3" name="ambito3"/><span> &nbsp;Cooperaci&oacute;n para el Desarrollo</span><br/>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Experiencia en supervisi&oacute;n: </label> <br>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Disponibilidad: </label> <br>
                                <select name="iddisponibilidad" class="form-select-21" style="width: 300px;">
                                    <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Maximo nivel alcanzado: </label> <br>
                                <select name="idsupervision" class="form-select-21" style="width: 300px;">
                                    <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Maximo nivel en no supervisi&oacute;n: </label> <br>

                                <select name="idnosupervision" class="form-select-21" style="width: 300px;">
                                    <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">A&ntilde;os de experiencia en supervisi&oacute;n: </label> <br>
                                <span>Mayor que&nbsp;</span><input type="text" value="" class="input1" name="aniomas" size="5" maxlength="2" onkeyup="this.value = Numeros(this.value)" id="aniomas"/>
                                &nbsp;&nbsp;<span>Menor que&nbsp;</span><input type="text" value="" class="input1" name="aniomenos" size="5" maxlength="2" onkeyup="this.value = Numeros(this.value)" id="aniomenos"/>
                                <br/>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Recomendaci&oacute;n: </label>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Rangos de edad: </label> <br>
                                <span>Mayor que&nbsp;</span><input type="text" value="" class="input1" name="edadmas" size="5" maxlength="2" onkeyup="this.value = Numeros(this.value)" id="edadmas"/>
                                &nbsp;&nbsp;<span>Menor que&nbsp;</span><input type="text" value="" class="input1" name="edadmenos" size="5" maxlength="2" onkeyup="this.value = Numeros(this.value)" id="edadmenos"/>
                                <br/>
                                <div class="limpiar-espacio" style="height: 7px;"></div>
                                <label style="margin-left: 100px;border: 2px solid red; border-top: 2px solid white;text-align: center;padding-left:  50px;padding-right: 50px;margin-top: 10px;">Entre</label><br/>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >        
                                <label class="titulo1">Cliente: </label> <br>
                                <select name="idcliente" class="form-select-21" style="width: 300px;">
                                    <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">G&eacute;nero: </label>
                                <br>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Ultima pretenci&oacute;n salarial: </label> <br>
                                <span>Mayor que&nbsp;</span> <input type="text" value="" class="input1" name="salariomas" size="5" maxlength="10" onkeyup="this.value = Numeros(this.value)" id="salariomas"/>
                                &nbsp;&nbsp;<span>Menor que&nbsp;</span><input type="text" value="" class="input1" name="salariomenos" size="5" maxlength="10" onkeyup="this.value = Numeros(this.value)" id="salariomenos"/>
                                <div class="limpiar-espacio" style="height: 7px"></div>
                                <label style="margin-left: 100px;border: 2px solid red; border-top: 2px solid white;text-align: center;padding-left:  50px;padding-right: 50px;margin-top: 10px;">Entre</label><br/>
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Cargos desempe&ntilde;ados: </label> <br>
                                <input name="cargo" value="" class="input1" type="text"/>
                            </div>
                        </div>
                        <div class="limpiar-espacio"></div>
                        <?php
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                ...
                                <label class="titulo1">Fecha de modificaci&oacute;n de CV:  </label><br>
                                <select name="fechacv" class="form-select-21" style="width: 300px;">
                        ...
                        <div class="contenedor-criterios">
                            ...
                            <div class="div-criterio2" >
                                <label class="titulo1">Otros idiomas: </label> <br>
                                <select name="idotroidioma" class="form-select-21" style="width: 300px;" >
                                    <?php
                ...
                <input type="text" class="input1" id="stringcriterios" style="display: none;" value="<?php echo $stringcriterios; ?>">
            </form>
...
//                                            validarCiudad();
                            ...
                            function validarProfesion() {
                                ...
                                if (arrayProfesiones.length > 0)
                                {
                                    ...
                                    $("#mensajeprofesion").html("debe seleccionar al menos una profesi&oacute;n");
                                    return false;
                                }
                            }
                            function validarRecomendacion() {
                                ...
                                if (arrayRecomendacion.length > 0)
                                {
                                    ...
                                    $("#mensajeRecomendacion").html("debe seleccionar al menos una recomendaci&oacute;n");
                                    return false;
                                }
                            }
                            ...
                            function validarIngles() {
                                ...
                                if (arrayCampos.length > 0)
                                {
                                    ...
                                    $("#mensajeingles").html("debe seleccionar al menos una opci&oacute;n de habla ingles");
                                    return false;
                                }
                            }
                            ...
                            function validarPais() {
                                ...
                                if (solo == true || todo == true)
                                {
                                    ...
                                    $("#mensajepais").html("debe seleccionar al menos una opci&oacute;n");
                                    return false;
                                }
                            }
