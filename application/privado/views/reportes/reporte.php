...
if (@$postulante) {
    ...
    if ($residencia)
        $cabecera_listado .= '<tr><td align="right"><b> Pa&iacute;s de residencia: </b></td><td align="left">' . $residencia . '</td></tr>';
    if ($disponibilidad > 0)
        $cabecera_listado .= '<tr><td align="right"><b> Disponibilidad: </b></td><td align="left">' . $this->disponibilidad[$disponibilidad] . '</td></tr>';
    if ($genero > 0)
        $cabecera_listado .= '<tr><td align="right"><b> G&eacute;nero: </b></td><td align="left">' . $this->genero[$genero] . '</td></tr>';
    if ($cliente)
    ...
    if ($experienciaSupervicion)
        $cabecera_listado .= '<tr><td align="right"><b> Experiencia en supervisi&oacute;n: </b></td><td align="left">' . $experienciaSupervicion . '</td></tr>';
    if ($nivelAlcanzado)
        $cabecera_listado .= '<tr><td align="right"><b> Maximo nivel alcanzado: </b></td><td align="left">' . $nivelAlcanzado . '</td></tr>';
    if ($pretencionSalarial)
        $cabecera_listado .= '<tr><td align="right"><b> Ultima pretenci&oacute;n salarial: </b></td><td align="left">' . $pretencionSalarial . '</td></tr>';
//    if($profesion)
//        $cabecera_listado.='<tr><td align="right"><b> Profesi&oacute;n: </b></td><td align="left">'.$this->area_pro[$profesion].'</td></tr>';
//    else
//        $cabecera_listado.='<tr><td align="right"><b> Profesi&oacute;n: </b></td><td align="left">Todas las Profesiones</td></tr>';
//    if ($area_exp)
//        $cabecera_listado .= '<tr><td align="right"><b>  &aacute;rea de experiencia: </b></td><td align="left">' . $this->area_exp[$area_exp] . '</td></tr>';
//    else
//        $cabecera_listado .= '<tr><td align="right"><b>  &aacute;rea de experiencia: </b></td><td align="left">Todas las  &aacute;reas de Experiencia</td></tr>';
//    if ($recomendacion)
//        $cabecera_listado .= '<tr><td align="right"><b> Recomendaci&oacute;n: </b></td><td align="left">' . $this->recomendaciones[$recomendacion] . '</td></tr>';
//    else
//        $cabecera_listado .= '<tr><td align="right"><b> Recomendaci&oacute;n: </b></td><td align="left">Todas las Recomendaciones</td></tr>';
//    if ($cliente)
            ...
            for ($i = 0; $i < count($campos_reales); $i++) {
                if ($campos_reales[$i] == "ambito") {
                    ...
                    foreach ($arrayAmbito as $key => $value) {
                        ...
                        if ($value == 3) {
                            $ambitos[] = "Cooperaci&oacute;n para el Desarrollo";
                        }
                    }
...
if (!@$ocultarPostulaciones) {
    ...
    <div style="display: inline-block; float: left; margin-left: 50px; text-align: left;">
        ...
        if ($btnDeshabilitado != "") {
            ?>
            <div class = "alerta-incorrecta-criterios">Bot&oacute;n deshabilitado al ser el resultado mayor a 200 datos o no existir datos</div>
            <?php
        }
        ?>
    </div>
