...
if($facturacion)
    $cabecera_listado.='<tr><td align="left"><b> Tipo Facturaci&oacute;n: </b> '.$this->facturaciones[$facturacion].'</td></tr>';
else
    $cabecera_listado.='<tr><td align="left"><b> Tipo Facturaci&oacute;n: </b> Todas las Facturaciones</td></tr>';
    ...
    foreach ($datos as $ser=>$filas) {
        ...
        switch ($ser) {
            case 7:
                ...
                if(!$facturacion)
                    $cabecera_listado1.='<th align="center" valign="middle">Tipo Facturaci&oacute;n</th>';
