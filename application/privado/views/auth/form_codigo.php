...
<div id="fondo_ingreso">
    ...
    <div id="caja1" align="center">
          <?php echo $sms; ?>
                <br>
                <?php echo form_open_multipart('Autenticar/verifica'); ?>
                    <div class="form-group">
                        <label class="col-md-12"></label>
                        <div class="col-md-12">
                            <input type="text" name="code"  class="form-control form-control-line" required="" autofocus>
                            <small class="form-control-feedback"> <code> <?php echo $error; ?> </code> </small>
                    ...
                    <br>
                     <div class="form-group">
                        <div class="col-sm-12" align="center">
                            <button type="submit" class="btn-etika btn">Verificar</button>
...
<table align="center" cellpadding="8">        
        <tr>
            <td align="center">
                <span id="siteseal">
                    <script type="text/javascript" src="https://seal.starfieldtech.com/getSeal?sealID=4oh6MsPttpdX2y1QrCCBWoB7Yv44YWMUBhnmPY0gOlefiKREodbVZiLevGl0"></script><br/><a style="font-family: arial; font-size: 9px" href="http://www.starfieldtech.com" target="_blank"
                    >SSL Certificate</a>
