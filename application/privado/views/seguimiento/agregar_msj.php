...
<?php echo form_open_multipart('Seguimiento/create_mensaje'); ?>   
<div class="row">
  <div class="col-md-2"></div>
  <div class="col-md-4" align="left">
    <div class="form-group">
      <label>Titulo del Mensaje: </label>
      <input type="text" class="form-control input1" value="<?php echo $titulo_msj; ?>" name="titulo" required="">
    </div>    
  ...
  <div class="col-md-8" align="left">
    <label>Mensaje de bienvenida: </label>
          ...
          <?php                 
            ...
            ?>
            <div class="error"><?php echo $error_msj; ?></div>
  </div>
</div>
