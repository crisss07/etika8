...
<?php echo form_open_multipart('Evaluacion/upd_bienvenida'); ?>   
<div class="row">
  <div class="col-md-4" style="font-size:16px;vertical-align: center;" align="right">Texto de bienvenida:</div>
