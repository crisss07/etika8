...
//$this->load->view('botones');
                        ...
                        <!-- ini combo buscar -->
                        <?php if ($ordencampo && $this->idp != 3 && $this->idp != 12) { ?>
                            <div align="right">
                                <div id="barra_orden">
...
//fin enlaces label
                ...
                foreach ($datos as $fila) {
                    ...
                    <!--fin de color a las celdas-->
                        ...
                        <?php
                        if ($orden && $this->idp != 3 && $this->idp != 12) {
                            ?>
                        ...
                        <td align="<?php echo $alineacionw; ?>" valign="<?php echo $alineacionh; ?>">
                            ...
                            if ($fila[$prefijo . 'id'] != 7) {
                                ...
                                if($this->idp==8)
                                {
                                    echo anchor($this->controlador . 'eliminar/id/' . $fila[$prefijo . 'id'] . '/idp/' . $this->idp, '<img width="30px" src="'.$this->tool_entidad->sitio().'files/img/privado/eliminar.png" alt="eliminar">', array('class' => 'enlace_a1', 'onclick' => "return confirmar('$msj_confirmar')"));
                                }
                                else{
