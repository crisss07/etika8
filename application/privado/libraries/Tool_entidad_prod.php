...
class Tool_entidad {
    ...
    function __construct(){
        ...
        $this->constantes['sitiopri']='/admin.php/';
        $this->constantes['nombresitio']='/';
        $this->constantes['presession']='admin_siste_pri_etika';
        ...
        $this->constantes['titulo_sitio']='Area Privada - Sistema de Postulación';
        // enlace bucket S3
        $this->constantes['aws_bucket']='elasticbeanstalk-us-east-2-147797252166';
        $this->constantes['aws_url']='https://elasticbeanstalk-us-east-2-147797252166.s3.us-east-2.amazonaws.com/';

        }else{
        $this->constantes['baseurl']='..'.$root;
        $this->constantes['sitio']= $root.'index.php/';
        $this->constantes['sitiopri']=$root.'admin.php/';
