...
class Notificacion_model extends CI_Model{
    ...
    function agregar_datos_edicion($prefijo,$titulo,$contenido,$id)    
    {   
        $this->db->set($this->prefijo.'titulo',$titulo);   
        $this->db->set($this->prefijo.'contenido',$contenido);    
