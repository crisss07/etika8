...
echo '
	...
	</table><font size="-2" face="Geneva, Arial, Helvetica, sans-serif" color=red>1.Selceccione MES - 2.Año - 3.Click en "Ir al Mes" - 4. Click en la fecha(día) </font><br>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$valpred){
	global $raiz;
	
	echo '
	<INPUT name="'.$nombrecampo.'" size="25" value="'.$valpred.'"onFocus="this.blur()">
	<input type=button value="Seleccionar" enable="Off" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';
}
?>